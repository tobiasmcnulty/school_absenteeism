...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('absences', '0003_auto_20141029_1827'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='parent',
            name='address_ptr',
            field=models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, default=1, serialize=False, to='absences.Address'),
